// -----------------------------------------------------------------------------------------------------------------
// <copyright file="MouseKeyPassGate.cs" company="my-libraries">
...
internal class MouseKeyPassGate
{
    ...
    public bool Pass(IntPtr wParam, IntPtr lParam)
    {
        ...
        {
            case MouseAction.LeftClick:
                return wParam == WM.LBUTTONUP;
            case MouseAction.RightClick:
                return wParam == WM.RBUTTONUP;
            case MouseAction.MiddleClick:
            case MouseAction.WheelClick:
                return wParam == WM.MBUTTONUP;
            case MouseAction.LeftDoubleClick when wParam == WM.LBUTTONDOWN:
                return _recorder.Pass(WM.LBUTTONDOWN);
            case MouseAction.LeftDoubleClick when wParam == WM.LBUTTONUP:
                return _recorder.Pass(WM.LBUTTONUP);
            case MouseAction.RightDoubleClick when wParam == WM.RBUTTONDOWN:
                return _recorder.Pass(WM.RBUTTONDOWN);
            case MouseAction.RightDoubleClick when wParam == WM.RBUTTONUP:
                return _recorder.Pass(WM.RBUTTONUP);
            case MouseAction.MiddleDoubleClick when wParam == WM.MBUTTONDOWN:
                return _recorder.Pass(WM.MBUTTONDOWN);
            case MouseAction.MiddleDoubleClick when wParam == WM.MBUTTONUP:
                return _recorder.Pass(WM.MBUTTONUP);
            default:
                return false;
        }
